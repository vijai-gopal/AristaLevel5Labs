...
# Open a session with borderleaf1-DC1. The script will find .eapi.conf and reference the credentials automatically

connect = pyeapi.connect_to("borderleaf1-DC1")
